  ...
  _trySubmit() async {
    ...
    try {
      if (_image == null) {
        ...
        // final _uid = user!.uid;
        var id = uuid.v4();
        await FirebaseFirestore.instance.collection('Buildings').doc(id).set({
          'name': _packageTitle,
          'lat': _packageDescription,
          "description": desc,
          'long': _packagePrice,
          'image': _url,
          'id': id,
        ...
        // } else {
        //   await FirebaseFirestore.instance.collection('buildings').doc(packageId).set({
        //     'title': _packageTitle,
