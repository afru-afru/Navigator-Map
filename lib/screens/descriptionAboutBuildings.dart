...
class descriptionAboutBuildings extends StatefulWidget {
   String id;


  descriptionAboutBuildings({super.key, required this.id, required this.title});
  ...
  @override
  State<descriptionAboutBuildings> createState() => _MyHomePageState();
}


class _MyHomePageState extends State<descriptionAboutBuildings> {
